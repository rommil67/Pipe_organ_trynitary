...
NoteButton buttons[] = {
  ...
  // {A0, {note(Ab, 4), CHANNEL_2}},
    ...
    */
    ...
    {A1, {note(C, 2), CHANNEL_2}},
    {A0, {note(Db, 2), CHANNEL_2}},
    {A3, {note(D, 2), CHANNEL_2}},
    {A2, {note(Eb, 2), CHANNEL_2}},
    {A5, {note(E, 2), CHANNEL_2}},
    {A4, {note(F_, 2), CHANNEL_2}},
    {A7, {note(Gb, 2), CHANNEL_2}},
    {A6, {note(G, 2), CHANNEL_2}},
    {A9, {note(Ab, 2), CHANNEL_2}},
    {A8, {note(A, 2), CHANNEL_2}},
    {A11, {note(Bb, 2), CHANNEL_2}},
    {A10, {note(B, 2), CHANNEL_2}},
    {A13, {note(C, 3), CHANNEL_2}},
    {A12, {note(Db, 3), CHANNEL_2}},
    {A15, {note(D, 3), CHANNEL_2}},
    {A14, {note(Eb, 3), CHANNEL_2}},
    {33, {note(E, 3), CHANNEL_2}},
    {32, {note(F_, 3), CHANNEL_2}},
    {35, {note(Gb, 3), CHANNEL_2}},
    {34, {note(G, 3), CHANNEL_2}},
    {37, {note(Ab, 3), CHANNEL_2}},
    {36, {note(A, 3), CHANNEL_2}},
    {39, {note(Bb, 3), CHANNEL_2}},
    {38, {note(B, 3), CHANNEL_2}},
    {41, {note(C, 4), CHANNEL_2}},
    {40, {note(Db, 4), CHANNEL_2}},
    {43, {note(D, 4), CHANNEL_2}},
    {42, {note(Eb, 4), CHANNEL_2}},
    {45, {note(E, 4), CHANNEL_2}},
    {44, {note(F_, 4), CHANNEL_2}},
    {47, {note(Gb, 4), CHANNEL_2}},
    {46, {note(G, 4), CHANNEL_2}},
